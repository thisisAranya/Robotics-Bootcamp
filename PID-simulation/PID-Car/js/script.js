...
function setupEventListeners() {
  ...
  buttons.presetPI.onclick = () => setPreset(0.2, 0, 0.015);   // PI: Good steady-state, moderate overshoot
  buttons.presetUnder.onclick = () => setPreset(0.4, 0.5, 0.01); // Underdamped: Fast, oscillatory
}
